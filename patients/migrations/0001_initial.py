...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('test_name', models.CharField(choices=[('histology', 'Histology'), ('cytology', 'Cytology'), ('pbf', 'Peripheral Blood Film')], max_length=255, verbose_name='Test Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('macroscopy_description', models.TextField(verbose_name='Macroscopy Description')),
                ('microscopy_description', models.TextField(verbose_name='Microscopy Description')),
